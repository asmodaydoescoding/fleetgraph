...
An optional Fleet Graph starter topology based on the fleet proposed in
[Fleet Graph PR #5](https://github.com/asmodaydoescoding/fleetgraph/pull/5).
...
The Fleet Graph topology was assembled and contributed by
...
1. Install or obtain the source profiles separately from the upstream MIT
   repository.
2. Back up the current Fleet Graph topology.
3. Preview `fleet_graph.example.yaml` and select the departments you want.
4. Apply it through Fleet Graph's reviewed graph-save flow.
