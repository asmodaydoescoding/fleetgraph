...
export function Select(props) {
  ...
  return React.createElement('select', { 'data-slot': 'sdk-select', value: props.value, defaultValue: undefined },
    items.map((o, i) => React.createElement('option', { key: o.props.value || ('opt-' + i), value: o.props.value }, o.props.children)))
}
...
console.log(`render-harness summary: ${passed} passed, ${failed} failed`)
